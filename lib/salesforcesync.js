...
SalesforceSync.prototype.syncRecords = function(callback){
    this.getSFOrgs(this.getZDMatches.bind(this,callback));
};

SalesforceSync.prototype.getSFOrgs = function(callback){
    salesforce().getAllAccounts(callback);
};
